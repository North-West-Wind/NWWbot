                ...
                if (isNaN(parseInt(amount.first().content))) {
                  con.query(
                    ...
                    async function(err, results, fields) {
                      if (amount.first().content === "quarter") {
                        var deposits =
                          Math.round(
                            (Number(newResults[0].currency) / 4 + Number.EPSILON) *
                              100
                          ) / 100;
                        var newCurrency =
                        ...
                        var deposits =
                          Math.round(
                            (Number(newResults[0].currency) / 2 + Number.EPSILON) *
                              100
                          ) / 100;
                        var newCurrency =
                          Number(newResults[0].currency) - deposits;
                        ...
                        var deposits =
                          Math.round(
                            (Number(newResults[0].currency) + Number.EPSILON) * 100
                          ) / 100;
                        var newCurrency =
                          Number(newResults[0].currency) - deposits;
                        var newBank = Number(newResults[0].bank) + deposits;
                  ...
                  con.query(
                    ...
                    function(err, results, fields) {
                      var deposits = Number(amount.first().content) > Number(newResults[0].currency) ? Number(newResults[0].currency) : Number(amount.first().content);
                      var newCurrency = Number(newResults[0].currency) - deposits;
                      var newBank = Number(newResults[0].bank) + deposits;
                      con.query(
                        "UPDATE currency SET `currency` = '" +
                          newCurrency +
                ...
                if (isNaN(parseInt(amount.first().content))) {
                  con.query(
                    ...
                    async function(err, results, fields) {
                      if (amount.first().content === "quarter") {
                        var deposits =
                          Math.round(
                            (Number(newResults[0].bank) / 4 + Number.EPSILON) * 100
                          ) / 100;
                        var newCurrency =
                          Number(newResults[0].currency) + deposits;
                        var newBank = Number(newResults[0].bank) - deposits;
                        ...
                        var deposits =
                          Math.round(
                            (Number(newResults[0].bank) / 2 + Number.EPSILON) * 100
                          ) / 100;
                        var newCurrency =
                          Number(newResults[0].currency) + deposits;
                        var newBank = Number(newResults[0].bank) - deposits;
                        ...
                        var deposits =
                          Math.round(
                            (Number(newResults[0].bank) + Number.EPSILON) * 100
                          ) / 100;
                        var newCurrency =
                          Number(newResults[0].currency) + deposits;
                        var newBank = Number(newResults[0].bank) - deposits;
                  ...
                  con.query(
                    "SELECT * FROM currency WHERE user_id = " +
                      ...
                      message.guild.id,
                    function(err, results, fields) {
                      var deposits = Number(amount.first().content) > Number(newResults[0].bank) ? Number(newResults[0].bank) : Number(amount.first().content);
                      var newCurrency = Number(newResults[0].currency) + deposits;
                      var newBank = Number(newResults[0].bank) - deposits;
                      con.query(
                        "UPDATE currency SET `currency` = '" +
