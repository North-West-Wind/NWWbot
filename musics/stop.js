module.exports = {
  ...
  music(message, serverQueue) {
    if ((message.member.voice.channelID !== guild.me.voice.channelID) && serverQueue.playing) return message.channel.send("You have to be in a voice channel to stop the music when the bot is playing!");
    if (!serverQueue) {
